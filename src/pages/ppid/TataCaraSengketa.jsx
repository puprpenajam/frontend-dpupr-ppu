  ...
  return (
    <div className="mb-8">
      ...
      <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-6 mb-8 border-l-4 border-red-600">
        <h3 className="text-lg font-bold text-red-800 mb-3">âš ï¸ Kapan Bisa Mengajukan Sengketa?</h3>
      ...
      <div className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-50 rounded-lg p-5 border-l-4 border-blue-600">
            <h4 className="font-bold text-blue-800 mb-2">ðŸ“„ Dokumen yang Diperlukan:</h4>
            <ul className="space-y-1 text-sm text-gray-700">
              <li>â€¢ Surat permohonan penyelesaian sengketa</li>
              <li>â€¢ Fotokopi identitas pemoh on (KTP/SIM/Paspor)</li>
              <li>â€¢ Bukti penerimaan permohonan informasi dari PPID</li>
              <li>â€¢ Bukti pengajuan keberatan dan tanggapannya</li>
              <li>â€¢ Alasan mengajukan sengketa</li>
            </ul>
          </div>
          <div className="bg-blue-50 rounded-lg p-5 border-l-4 border-blue-600">
            <h4 className="font-bold text-blue-800 mb-2">â±ï¸ Batas Waktu Pengajuan:</h4>
            <ul className="space-y-1 text-sm text-gray-700">
              <li>â€¢ Diajukan paling lambat 14 hari kerja sejak diterimanya tanggapan keberatan</li>
              <li>â€¢ Atau 14 hari kerja setelah lewatnya batas waktu 30 hari kerja proses keberatan</li>
              <li>â€¢ Keterlambatan pengajuan dapat menyebabkan permohonan tidak dapat diproses</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
            ...
            <div className="flex-1">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <div className="bg-white/80 p-3 rounded-lg">
                  <p className="font-semibold text-blue-700 mb-1">ðŸ“‹ Prosedur</p>
                  <p className="text-sm text-gray-600">Mengikuti tata cara pengajuan sengketa yang telah ditetapkan</p>
                </div>
                <div className="bg-white/80 p-3 rounded-lg">
                  <p className="font-semibold text-blue-700 mb-1">ðŸ“„ Substansi</p>
        ...
        <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-6 border-l-4 border-blue-600">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-blue-700 mb-2">Mediasi</h3>
              <p className="text-gray-700 leading-relaxed mb-3">
              ...
              <div className="bg-white/80 p-3 rounded-lg">
                <p className="font-semibold text-blue-700 mb-2">Hasil Mediasi:</p>
      ...
      <div className="mt-8 bg-gradient-to-r from-dpupr-blue to-blue-600 rounded-xl p-6" style={{ color: '#ffffff' }}>
        <h3 className="text-xl font-bold mb-4" style={{ color: '#ffffff' }}>ðŸ“ž Informasi Kontak</h3>
      ...
      <div className="mt-8 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-6 border-l-4 border-purple-600">
        <h3 className="text-lg font-bold text-purple-800 mb-3">â° Waktu Proses Penyelesaian Sengketa</h3>
        <ul className="space-y-2 text-gray-700">
          <li className="flex items-start gap-2">
      ...
      <div className="mt-8 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-6 border-l-4 border-yellow-500">
        <h3 className="text-lg font-bold text-yellow-800 mb-3">âš–ï¸ Kekuatan Hukum Putusan</h3>
      ...
      <div className="mt-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
        <h3 className="text-lg font-bold text-gray-800 mb-3">ðŸ“œ Dasar Hukum Penyelesaian Sengketa</h3>
        <ul className="space-y-2 text-sm text-gray-700">
          <li className="flex items-start gap-2">
