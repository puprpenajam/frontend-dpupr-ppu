  ...
  return (
    <div className="mb-8">
      ...
      <div className="bg-gradient-to-r from-dpupr-blue to-blue-600 rounded-xl p-6 mb-8" style={{ color: '#ffffff' }}>
        <h3 className="text-xl font-bold mb-3" style={{ color: '#ffffff' }}>📋 Tentang Permohonan Informasi</h3>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-6 border-l-4 border-green-600">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-green-700 mb-2">Petugas Mengecek Kelengkapan Syarat Permohonan</h3>
              <p className="text-gray-700 leading-relaxed mb-3">
                Petugas memeriksa kelengkapan dokumen dan syarat permohonan yang diajukan.
              </p>
              <div className="grid md:grid-cols-2 gap-3">
                <div className="bg-white/80 p-3 rounded-lg">
                  <p className="font-semibold text-green-700 mb-1">✓ Lengkap</p>
                  <p className="text-sm text-gray-600">Lanjut ke proses selanjutnya</p>
                </div>
                <div className="bg-white/80 p-3 rounded-lg">
                  <p className="font-semibold text-red-600 mb-1">✗ Tidak Lengkap</p>
      ...
      <div className="mt-8 bg-gradient-to-r from-dpupr-blue to-blue-600 rounded-xl p-6" style={{ color: '#ffffff' }}>
        <h3 className="text-xl font-bold mb-4" style={{ color: '#ffffff' }}>⏰ Waktu Proses Permohonan</h3>
      ...
      <div className="mt-8 grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-red-50 rounded-xl p-6 border-l-4 border-red-600">
          <h3 className="text-lg font-bold text-red-800 mb-3">⛔ Informasi yang Dikecualikan</h3>
          <ul className="space-y-2 text-sm text-gray-700">
            <li className="flex items-start gap-2">
      ...
      <div className="mt-8 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-6 border-l-4 border-yellow-500">
        <h3 className="text-lg font-bold text-yellow-800 mb-4">💡 Tips Mengajukan Permohonan yang Efektif</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <p className="font-semibold text-yellow-700 mb-2">📝 1. Jelas dan Spesifik</p>
          ...
          <div>
            <p className="font-semibold text-yellow-700 mb-2">📎 2. Lampirkan Dokumen Lengkap</p>
          ...
          <div>
            <p className="font-semibold text-yellow-700 mb-2">📞 3. Kontak yang Aktif</p>
          ...
          <div>
            <p className="font-semibold text-yellow-700 mb-2">🎯 4. Sebutkan Tujuan Penggunaan</p>
      ...
      <div className="mt-8 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6">
        <h3 className="text-lg font-bold text-blue-800 mb-3">💰 Biaya Layanan Informasi</h3>
